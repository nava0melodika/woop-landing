...
function Hero() {
  return (
    <section className="relative bg-white overflow-hidden min-h-[700px] flex items-center">
      ...
      <img
        src="https://api.builder.io/api/v1/image/assets/TEMP/559ab157b8b715718402c9a22d785aceb7428ba6?width=1415"
        alt=""
        aria-hidden
        className="absolute pointer-events-none"
        style={{ width: 707, height: 537, transform: "rotate(156.39deg)", opacity: 0.4, right: -100, top: 0 }}
      />
      <img
        src="https://api.builder.io/api/v1/image/assets/TEMP/5c7c14e2e174bad0a75c5577f08574365ff55ae6?width=1268"
        alt=""
        aria-hidden
        className="absolute pointer-events-none"
        style={{ width: 634, height: 576, transform: "rotate(-12.107deg)", opacity: 0.2, right: 0, top: 0 }}
      />
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20 w-full py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative flex items-center justify-center z-10">
          <img
            ...
            alt="Car"
            className="w-full max-w-[700px] object-contain drop-shadow-xl"
          />
        </div>
      </div>
    </section>
...
function WhyChooseUs() {
  ...
  return (
    <section className="relative bg-white overflow-hidden py-16 md:py-24">
      {/* Background decorations */}
      <img
        src="https://api.builder.io/api/v1/image/assets/TEMP/e56acee9ea4b2b93a0a9615329a0580a78c6d5be?width=1415"
        alt=""
        aria-hidden
        className="absolute pointer-events-none"
        style={{ width: 707, height: 537, transform: "rotate(-23.61deg)", opacity: 0.4, left: -300, top: -97 }}
      />
      <img
        src="https://api.builder.io/api/v1/image/assets/TEMP/080b110e0f66b410b2ecc6dee4370d15b5a4d457?width=1462"
        alt=""
        aria-hidden
        className="absolute pointer-events-none"
        style={{ width: 731, height: 538, opacity: 0.2, left: -84, top: 141 }}
      />
...
function DownloadApp() {
  return (
    <section className="relative bg-white overflow-hidden py-16 md:py-20">
      <img
        src="https://api.builder.io/api/v1/image/assets/TEMP/34fcfcc24bd5c62cd4416eba6232aaf24a97866f?width=1223"
        alt=""
        aria-hidden
        className="absolute pointer-events-none"
        style={{ width: 612, height: 464, transform: "rotate(156.39deg)", opacity: 0.4, right: 0, top: -50 }}
      />
      <img
        src="https://api.builder.io/api/v1/image/assets/TEMP/858d28119f4babdea7462f6ecee9df93efdb5240?width=1096"
        alt=""
        aria-hidden
        className="absolute pointer-events-none"
        style={{ width: 548, height: 498, transform: "rotate(-12.107deg)", opacity: 0.2, right: 0, top: -50 }}
      />
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative" style={{ width: 320, height: 650 }}>
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/65618b68fdef5a12e06d4508cff79ff178c16158?width=1040"
              alt=""
              aria-hidden
              className="absolute inset-0 w-full h-full opacity-70 object-contain"
            />
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/0f5ab6bb6f95cb8ef79aa6e26f489e6b2d4fd607?width=1040"
              alt="App mockup"
    ...
    <footer className="bg-[#1075DF] text-white pt-10 pb-8">
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20">
        ...
        <div className="border-t border-white/20 pt-6">
          <p className="font-poppins text-xs">Copyright 2025 ・ Rentcars, All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
